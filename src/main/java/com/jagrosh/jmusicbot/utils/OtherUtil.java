...
public class OtherUtil {
    ...
    public static String checkVersion(IPrompt prompt) {
        ...
        if (latestVersion != null && !latestVersion.equals(version)) {
            prompt.alert(IPrompt.Level.WARNING, "New version available!", "Version", String.format(NEW_VERSION_AVAILABLE, version, latestVersion));
        }
